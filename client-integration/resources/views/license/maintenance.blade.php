...
<head>
    ...
    <title>ARTDEVATA - Maintenance License</title>
    ...
    <style>
        ...
        * {
        ...
        .icon-box {
            ...
            height: 70px;
            border-radius: 20px;
            background: linear-gradient(135deg, var(--info), #0f766e);
            display: flex;
            justify-content: center;
            align-items: center;
            font-size: 30px;
            color: white;
            font-weight: bold;
            box-shadow: 0 20px 35px -18px rgba(13, 148, 136, 0.5);
            margin-bottom: 20px;
        }
...
<body>
    ...
    <div class="card">
        ...
        <p class="subtitle">
            Website Anda sedang dinonaktifkan sementara karena lisensi sedang diverifikasi
            atau tidak valid. Sistem akan kembali aktif setelah proses validasi selesai oleh
            tim support <span class="highlight">ARTDEVATA</span>.
        </p>

        <div class="alert-box">
            {{ $message ?? 'Website dinonaktifkan sementara karena lisensi tidak valid atau sedang diverifikasi ulang oleh sistem. Setelah lisensi valid kembali, akses akan otomatis dibuka tanpa perlu perubahan kode.' }}
        </div>
